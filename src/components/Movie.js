...
const Movie = () => {
    ...
    if (movieResult === null) return 'Loding...';
    ...
    return (
        <>
            ...
            <main className='w-full '>
                <div className="w-full relative h-[720px] overflow-hidden bg-black">
                    <div className="bg-header-gradient absolute top-0 bottom-0 left-0 right-0 z-10"></div>
                    <img className="h-[110vh] md:h-auto object-cover mx-auto brightness-[.3]"  src={BANNER_IMG_CDN_URL + backdrop_path} alt="moviebg" />
                    <div className="top-0 absolute w-full left-0 right-0 z-20">
                        <div className="container mx-auto">
                            <div className="w-full flex justify-start items-center mt-40">
                                <div className="w-1/5">
                                    <Image src={BANNER_IMG_CDN_URL + poster_path} alt="Poster" fallback={<Shimmer width={300} height={450} />} />
                                </div>
                                <div className="w-4/5">
                                    <div className="pl-5">
                                        <h1 className="text-4xl font-bold text-white mb-1">{title}
                                            <span className="text-slate-300 text-3xl">({release_date.slice(0, 4)})</span>
                                        </h1>
                                        ...
                                        <p className="text-slate-300 text-2xl italic mb-4">{tagline}</p>
                                        <div className="mb-4 flex justify-start items-center">                                    
                                            ...
                                            <span className="text-xl text-white ml-2">User Score</span>
                                            <Link onClick={openModal} className="text-white font-bold text-xl ml-5 flex items-center">
            ...
            {isOpen && 
                <div className="flex items-center justify-center h-screen bg-gray-100">
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
                        <div className="relative w-1/2 bg-white rounded shadow-lg">
